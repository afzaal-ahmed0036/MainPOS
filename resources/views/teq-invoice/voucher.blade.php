                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <select id="dish_table_id" name="dish_table_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Take Away...">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 AmountPaidByCard">
                                            <label>Amount Paid By Card/Tabby *</label>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $customer = DB::table('party')->where('PartyID', $draft->PartyID); ?>
                                                <tr>
...
<script type="text/javascript">
    ...
    $('#dish-filter').on('click', function(e){
        e.stopPropagation();
        $('.filter-window').show('slide', {direction: 'right'}, 'fast');
        $('.dish').show();
        $('.category').hide();
    ...
    $('.dish-img').on('click', function(){
        var dish_id = $(this).data('dish');

        $(".table-container").children().remove();
        $.get('get-dish-types-by-filter/' + dish_id, function(data) {
            ...
            if (Object.keys(data).length != 0) {
                $.each(data['name'], function(index) {
                    ...
                    var url = '{{ URL::asset('/assets/images/dish-types/') }}/';
                    if(index % 5 == 0 && index != 0)
                        tableData += '</tr><tr><td class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><img  src="'+url+''+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p><span>'+data['code'][index]+'</span></td>';
                    else
                        tableData += '<td class="product-img sound-btn" title="'+data['name'][index]+'" data-product = "'+product_info+'"><img  src="'+url+''+data['image'][index]+'" width="100%" /><p>'+data['name'][index]+'</p><span>'+data['code'][index]+'</span></td>';
                });
