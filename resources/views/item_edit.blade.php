                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <form action="{{ URL('/ItemUpdate') }}" enctype="multipart/form-data" method="post">
                                ...
                                <input type="hidden" name="InvMasterID" value="{{ $invMasterData->InvoiceMasterID }}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" id="stockQty" class="form-control"
                                                            name="stockQty" value="{{ $invMasterData->TotalQty }}">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="number" id="first-name" class="form-control"
                                                            name="CostPrice" step="0.01" value="{{ $item->CostPrice }}">
                                                    </div>
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="number" id="first-name" class="form-control"
                                                            name="SellingPrice" step="0.01" value="{{ $item->SellingPrice }}">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-2">
