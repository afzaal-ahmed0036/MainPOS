                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <a href="" class="auth-logo-dark">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-primary ">
                                            <img src="{{ asset('assets/images/square.svg') }}" height="40">
                                        </span>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="p-2 ">
                                <form class="form-horizontal" action="{{ URL('/UserVerify') }}" method="post">
                                    ...
                                    <div class="mt-4 text-center">
                                        <a href="{{ URL('/ForgotPassword') }}" class=" text-muted "><i
                                                class="mdi mdi-lock  me-1 text-muted"></i> Forgot your password?</a>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            ...
                            <p>Copyright 2022 {{ $company[0]->Name }}. All rights reserved. </p>
                        </div>
                    </div>
