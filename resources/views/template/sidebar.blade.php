            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li class="d-none"> <a href="{{ URL('/PurchaseOrder') }}" key="t-products">Purchase Order</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li id="exp-cat-menu"><a href="{{ route('voucher.create') }}" key="t-products">Create
                                Invoice</a></li>
                        <li id="exp-list-menu"><a href="{{ route('invoice.listing') }}" key="t-products">Invoice
                                Listing</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('warehouse.warehousestransfer') }}" key="t-products">Stock Adjustment</a>
                        </li>
                        <li><a href="{{ route('warehouse.stock-warehouses-in') }}" key="t-products">WareHouse Stock
                                In</a></li>
                        <li><a href="{{ route('warehouse.stock-warehouses-out') }}" key="t-products">WareHouse Stock
                                Out</a></li>
                ...
                <li class="d-none">
                    <a href="{{ route('coupons.index') }}" class="waves-effect">
                        ...
                        <span key="t-calendar">Coupon List</span>
                    </a>
                </li>
